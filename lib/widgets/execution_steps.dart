  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      ...
      child: BlocBuilder<ExecutionStepsStartCubit, bool>(
        builder: (context, isStarted) => SingleChildScrollView(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    BlocProvider(
                                      ...
                                      child: ExecutionSteps(index: index, step: nextStep++),
                                    ),
                                    Text(
                  ...
                  Container(
                    ...
                    child: OutlinedButton(
                      ...
                      onPressed: () {
                        ...
                        nextStep = 0;
                        context.read<ExecutionStepsStartCubit>().executionStepsStartSelect();
                      },
                    ),
                  ),
                ],
